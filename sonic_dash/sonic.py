...
mapbox_access_token = 'pk.eyJ1IjoibW9oYW1lZGRoYSIsImEiOiJjanJtZmRpeWYwaDhnNGFvNXRqZDNhbmJjIn0.IIpYluC9Mgl4PZkhAMriQQ'
map_data = pd.read_csv('https://raw.githubusercontent.com/kasamoh/Dash_app/master/sonic_dash/SONYC_Dataset.csv')
...
app.layout = html.Div([
    ...
    html.Div(
        [
            ...
            html.P(
                'Testing mapbox with flask and dash',
                style={'font-family': 'Helvetica',
                       "font-size": "120%",
                       "width": "80%"},
                className='eight columns',
...
def update_selected_row_indices_hist(selectedData, selected_row_indices):
    if selectedData:
        selected_row_indices = []
